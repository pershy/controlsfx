...
/**
 * {@code DateUtils} contains many useful methods related to Date and Calendar.
 */
public class DateUtils {
     ...
     * @deprecated replaced by {@link #minDates(java.util.List)} to comply with the new compilation regulation. We have
     ...
     * @deprecated replaced by {@link #maxDates(java.util.List)} to comply with the new compilation regulation. We have
